...
\begin{frame}
  \vfill
  \centering
  {\fontsize{30}{34}\selectfont\textbf{\color{paper}Live demo}}\\[12pt]
  {\large\color{faint}Watch \textcolor{accent}{\textbf{X}} and
   \textcolor{accent}{\textbf{Y}} flow through memory,}\\[2pt]
  {\large\color{faint}until the bad state lights up.}\\[2.4em]
  {\footnotesize\color{faint}jaspek.github.io/rotor-rust}
  \vfill
\end{frame}}

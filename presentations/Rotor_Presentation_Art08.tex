...
% paint-well swatch, bottom-right, fills as colour grows
\newcommand{\swatch}[1]{%
  \fill[#1, opacity=0.85] (14.98,0.4) rectangle (15.3,{0.4+0.46*\wo});
  \draw[penf] (14.98,0.4) rectangle (15.3,0.86);
  \node[inkl, anchor=east, font=\tiny\itshape] at (14.9,0.63) {colour};}

...
% =====================================================================
% FINAL DECK -- THE HAND-COLOURED ENGRAVING, FULLY PAINTED.
% The culminating image-led deck: 16 pen-and-ink plates, every one fully
% hand-coloured (all \setsat at 100), telling the whole project from the
% problem to the summit. Black engraving linework with watercolour washes,
% EB Garamond lettering. Pairs with SPEAKER_SCRIPT_Final.md.
...
\art{
  ...
  % colour washes -- a fully painted frontispiece (final)
  \begin{scope}\clip (0.95,4.0) rectangle (15.05,8.05);\wfill{wsky}{0.5}\end{scope}
  \begin{scope}\clip (0.95,0.95) rectangle (15.05,4.4);\wfill{wgreen2}{0.5}\end{scope}
  \begin{scope}\clip (7.6,0.95) rectangle (15.05,3.55);\wfill{wwater}{0.4}\end{scope}
  \begin{scope}\clip (1.2,4.4) -- (3.6,6.4) -- (5.2,5.2) -- (7.4,6.9) -- (9.0,5.6)
       -- (11.6,7.0) -- (13.2,5.3) -- (14.8,6.2) -- (14.8,4.4) -- cycle;\wfill{wslate}{0.4}\end{scope}
  \begin{scope}\clip (9.8,4.4) -- (11.8,6.1) -- (13.6,5.0) -- (15.05,5.7) -- (15.05,4.4) -- cycle;\wfill{wgreen}{0.55}\end{scope}
  \begin{scope}

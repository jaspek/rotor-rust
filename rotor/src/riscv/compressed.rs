...
fn decode_quadrant_1(
    ...
    result = builder.ite(
        id_sid,
        is_000,
        consts.nid_instr_id(InstrId::CAddi),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_001,
        consts.nid_instr_id(InstrId::CAddiw),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_010,
        consts.nid_instr_id(InstrId::CLi),
        result,
        None,
    );
    ...
    let lui_or_sp = builder.ite(
        id_sid,
        is_sp,
        consts.nid_instr_id(InstrId::CAddi16sp),
        consts.nid_instr_id(InstrId::CLui),
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_101,
        consts.nid_instr_id(InstrId::CJ),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_110,
        consts.nid_instr_id(InstrId::CBeqz),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_111,
        consts.nid_instr_id(InstrId::CBnez),
        result,
        None,
    );
...
fn decode_q1_arith(
    ...
    sub_result = builder.ite(
        id_sid,
        c,
        consts.nid_instr_id(InstrId::CSub),
        sub_result,
        None,
    );
    ...
    sub_result = builder.ite(
        id_sid,
        c,
        consts.nid_instr_id(InstrId::CXor),
        sub_result,
        None,
    );
    ...
    sub_result = builder.ite(
        id_sid,
        c,
        consts.nid_instr_id(InstrId::COr),
        sub_result,
        None,
    );
    ...
    sub_result = builder.ite(
        id_sid,
        c,
        consts.nid_instr_id(InstrId::CAnd),
        sub_result,
        None,
    );
    // bit12=1 (RV64C)
    ...
    sub_result = builder.ite(
        id_sid,
        c,
        consts.nid_instr_id(InstrId::CSubw),
        sub_result,
        None,
    );
    ...
    sub_result = builder.ite(
        id_sid,
        c,
        consts.nid_instr_id(InstrId::CAddw),
        sub_result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_10,
        consts.nid_instr_id(InstrId::CAndi),
        result,
        None,
    );
    result = builder.ite(
        id_sid,
        is_01,
        consts.nid_instr_id(InstrId::CSrai),
        result,
        None,
    );
    result = builder.ite(
        id_sid,
        is_00,
        consts.nid_instr_id(InstrId::CSrli),
        result,
        None,
    );
    result
...
fn decode_quadrant_2(
    ...
    result = builder.ite(
        id_sid,
        is_000,
        consts.nid_instr_id(InstrId::CSlli),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_010,
        consts.nid_instr_id(InstrId::CLwsp),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_011,
        consts.nid_instr_id(InstrId::CLdsp),
        result,
        None,
    );
    ...
    let bit12_0 = builder.ite(
        id_sid,
        rs2_is_zero,
        consts.nid_instr_id(InstrId::CJr),
        consts.nid_instr_id(InstrId::CMv),
        None,
    );
    let bit12_1 = builder.ite(
        id_sid,
        rs2_is_zero,
        consts.nid_instr_id(InstrId::CJalr),
        consts.nid_instr_id(InstrId::CAdd),
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_110,
        consts.nid_instr_id(InstrId::CSwsp),
        result,
        None,
    );
    ...
    result = builder.ite(
        id_sid,
        is_111,
        consts.nid_instr_id(InstrId::CSdsp),
        result,
        None,
    );

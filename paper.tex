...
\author{
\IEEEauthorblockN{Jasmin Begi\'{c}, Daniel Wassie}
\IEEEauthorblockA{Advanced Systems Engineering (ASE 2026), supervised by Christoph M.\ Kirsch\\
...
\begin{IEEEkeywords}
bounded model checking, BTOR2, RISC-V, symbolic execution, differential
testing, Rust
\end{IEEEkeywords}
...
crash described in Section~\ref{sec:cse}, and the visualizer with
twelve preloaded examples:
\begin{center}
\footnotesize
...
is the precise sense in which the two generators are equivalent.
